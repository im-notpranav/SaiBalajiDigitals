...
import { REMARK_TYPES, CLOSURE_REMARK_TYPES } from "@/lib/mock-data";
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        ...
        <div className="surface-panel p-6">
          ...
          <div className="space-y-4">
            <div>
              <div className="mb-2 text-xs font-semibold uppercase tracking-wider text-muted-foreground">Remark types</div>
              <div className="flex flex-wrap gap-1.5">
                {REMARK_TYPES.map((r) => <Badge key={r} variant="outline">{r}</Badge>)}
              </div>
            </div>
            <div>
